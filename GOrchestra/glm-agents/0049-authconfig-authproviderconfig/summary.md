...
**Generated**: 2026-05-30 09:41:16

**Status**: done
**Task**: Add AuthConfig and AuthProviderConfig types to internal/schema/schema.go.
...
Added AuthConfig and AuthProviderConfig types to internal/schema/schema.go with OIDC provider fields (AWS, GCP, Azure), and added Auth field to SmokeConfig struct.
...
```
9354113 chore: session review (score=8, issues=0)
dacdfce feat(schema): add AuthConfig types for OIDC providers (FEAT-049)
```
