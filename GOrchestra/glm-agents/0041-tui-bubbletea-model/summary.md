...
Created TUI reporter adapter and Bubbletea model in internal/tui/ with //go:build tui tag
...
```
433ab34 feat(tui): bubbletea model and reporter adapter (FEAT-051)
```
...
.gorchestra/fingerprint-cache.json |  6 +++---
 ...
 GOrchestra/intel/architecture.json | 43 +++++++++++++++++---------------------
